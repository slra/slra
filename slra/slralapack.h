...
void mb02gd_(const char *typet, const char *triu, const size_t *k, 
             const size_t *n, const size_t *nl,  const size_t *p, 
             const size_t *s, double *t, const size_t* ldt, double *rb, 
             const size_t *ldrb, double *dwork, const size_t *ldwork, 
             size_t *info);
#endif             
             
void dtbtrs_(const char* uplo, const char* trans, const char* diag, 
             const size_t* n, const  size_t* kd, const size_t* nrhs, 
             const double* ab, const size_t* ldab, const double* b, 
             const size_t* ldb, size_t* info); 

void dpbtrs_(const char* uplo, const size_t* n, const size_t* kd, 
             const size_t* nrhs, const double* ab, const size_t* ldab,
             const double* b, const size_t* ldb,  size_t* info); 

void dpbtrf_(const char* uplo, const size_t* n, const size_t* kd, 
...
void dormlq_(const char *side, const char *trans, const size_t *m, 
             const size_t *n, const size_t *k, double *a, const size_t *lda, 
             double *tau, double *c, const size_t *ldc, 
...
void dgesvd_(const char* jobu, const char* jobvt, const size_t* m, 
             ...
             const double* u, const size_t* ldu, 
