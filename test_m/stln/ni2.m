...
[pA,qA]=size(A);
slow=1; %setting this to 1 uses no optimization of efficiency at all
...
if slow==5
  tot=tf0+tf1+tf2+tf3+tf4;
  fprintf('Generators: %d flops, %4.2f%% \n',tf0,tf0/tot*100)  
  fprintf('fast QR: %d flops, %4.2f%% \n',tf1,tf1/tot*100)   
  fprintf('rhs construct: %d flops, %4.2f%% \n',tf2,tf2/tot*100)
  fprintf('LT system: %d flops, %4.2f%% \n',tf3,tf3/tot*100)
  fprintf('UT system: %d flops, %4.2f%% \n',tf4,tf4/tot*100)
  fprintf('Total number of flops: %d flops\n',tot)
end  
