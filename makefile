...
SLRA_SRC_FILES = slra/slra.cpp slra/slra_common.cpp slra/slra_computation.cpp\
		slra/slra_layered_hankel.cpp slra/slra_dgamma_btbanded.cpp \
		slra/slra_layered_hankel_weighted.cpp slra/slra_striped.cpp \
		slra/slra_cholesky_bbanded.cpp slra/slra_optimize.cpp \
		slra/slra_cholesky_btbanded.cpp slra/slra_utils.cpp \
...
testc-slicot : test.o slra.a SLICOT.a
	...
	slra.a SLICOT.a -lgsl -lcblas -llapack -latlas -lblas -lm -lgfortran
...
clean : 
	rm *.o slra/*.o *.mex* SLICOT.a slra.a
