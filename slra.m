...
%
% [xh, info, vxh, ph] = stls(p, s, r, x0, opt, phi)
%
% Input arguments:
%
% P - parameter vector
...
%                   'll'  - ...lmder (default)
%                   'ls'  - ...lmsder
%                   'q' - Quasi-Newton, gsl_multimin_fdfminimizer_...
%                   'qb'  - ...bfgs (default)
%                   'q2'  - ...bfgs2
%                   'qp'  - ...conjugate_pr
%                   'qf'  - ...conjugate_fr
%                   'n' - Nead-Melder, gsl_multimin_fminimizer_...
...
%   INFO.FMIN = (||P - Ph||_2)^2
% VXH  - asymptotic covariance matrix of XH
